...
export default function Page() {
    ...
    const cards = [
      ...
      {
        imagen: '/imagenes/Bots-de-Mensajeria-Seervicios.jpg',
      ...
      {
        imagen: '/imagenes/Estrategia-de-Creacion-de-Contenidos-Servicios.jpg',
  ...
  return (
    <main className="w-full bg-gris pb-20">
      ...
      <Banner imagen="/imagenes/Servicios-AE-Agencia-2.jpg" titulo="SERVICIOS"/>
